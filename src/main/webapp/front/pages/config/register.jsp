...
<html>
	...
	<body>
			...
			<form class="layui-form login-form" :style='{"padding":"80px 60px","boxShadow":"18px -18px 0px  rgba(107, 194, 186, 0.2)","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(107, 194, 186, 0.56)","borderRadius":"20px","borderWidth":"0","width":"500px","borderStyle":"solid","justifyContent":"center","height":"auto"}'>
				...
				<div class="title" v-if="true" :style='{"padding":"0","boxShadow":"0px 0px 0 0px rgba(110,22,64,.8)","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","isshow":true,"borderRadius":"100%","borderWidth":"0","width":"100%","lineHeight":"38px","fontSize":"24px","borderStyle":"solid"}'>轮播图管理注册</p></div>
