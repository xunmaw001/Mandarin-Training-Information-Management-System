...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="peixunshijian" name="peixunshijian" class="form-control" v-model="ruleForm.peixunshijian" readonly>
									</div>

									<div class="form-group col-md-6">
									<label>课表附件</label>

									<button class="btn-upload" id="kebiaofujian">点击下载</button>
									</div>
									<div class="form-group col-md-6">
									<label>工号</label>
	...
	<script>
		...
		function setDownloadBtn(){
			var kebiaofujianUrl = "download('" + ruleForm.kebiaofujian + "')";
			$("#kebiaofujian").attr("onclick",kebiaofujianUrl);
		}			
		//设置音视频播放链接
