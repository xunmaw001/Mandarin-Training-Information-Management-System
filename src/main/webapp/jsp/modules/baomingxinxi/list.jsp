...
<body>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "成绩"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'chengjixinxi','是','','')");
			...
			crossBtn1.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'pingjiaxinxi','是','','')");
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"baomingxinxi");
