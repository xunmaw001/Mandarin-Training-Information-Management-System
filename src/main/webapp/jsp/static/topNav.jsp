<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<style>
		...
		.top-brand .menu-list-title {
			...
			background-image: url(http://codegen.caihongy.cn/20210716/52f6897f1e3246a1be905386f126daa3.png);
				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">普通话培训信息管理系统</a>
						</div>
